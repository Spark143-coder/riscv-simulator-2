...
//Based on forward signals generated by hazard detection unit it will set forwarding result
...
//It is special decode hazard detection which will detect hazard if there is some branch instruction
